...
# Scenario colors (colorblind-safe)
SCENARIO_COLORS = {
...
def load_data():
    ...
    data = {
        ...
        'stranded_summary': pd.read_csv('outputs/stranded_assets_summary.csv'),
        'stranded_facilities': pd.read_csv('outputs/stranded_assets_facilities.csv'),
