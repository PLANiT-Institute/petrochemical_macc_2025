...
The analysis covers 237 baseline facilities (243 with the Shaheen project) across Korea's major petrochemical complexes.

\begin{table}[H]
\centering
\caption{Facility Database Summary by Region}
\begin{tabular}{lccc}
\toprule
...
Other & 19 & 3,990 & 4.0 \\
\midrule
\textbf{Total} & \textbf{237} & \textbf{100,066} & \textbf{100.0} \\
\bottomrule
\end{tabular}
\end{table}

\subsection{Technology Portfolio}

Five decarbonization technologies are evaluated, each with specific applicability:
...
\begin{tabular}{lcccc}
\toprule
Technology & Application & Available & TRL & Key Parameter \\
\midrule
Heat Pump & $<$165$^\circ$C processes & 2025 & 9 & COP 4.0 \\
NCC-H$_2$ & Naphtha crackers & 2030 & 7 & 0.2 t-H$_2$/t-C$_2$H$_4$ \\
NCC-Electricity & Naphtha crackers & 2030 & 8 & 5.0 MWh/t-C$_2$H$_4$ \\
RE-PPA & All electricity & 2025 & N/A & Contract-based \\
RDH & High-temp BTX & 2026 & 8 & 93\% efficiency \\
\bottomrule
\end{tabular}
\end{table}

\subsection{MACC Calculation}
...
where $CAPEX_{ann}$ is annualized capital expenditure, $OPEX_{ann}$ is annual operating cost, $\Delta FuelCost$ is the fuel cost differential, and $Abatement$ is annual emission reduction.
