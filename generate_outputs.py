...
# Scenario display names (handles both old and new naming)
SCENARIO_NAMES = {
    'shaheen_ncc_h2': 'Shaheen + NCC-H2',
    'shaheen_ncc_elec': 'Shaheen + NCC-Elec',
    'shaheen_ncc_h2_15c': 'Shaheen + NCC-H2 (1.5°C)',
    'shaheen_ncc_h2_20c': 'Shaheen + NCC-H2 (2.0°C)',
    'shaheen_ncc_elec_15c': 'Shaheen + NCC-Elec (1.5°C)',
    'shaheen_ncc_elec_20c': 'Shaheen + NCC-Elec (2.0°C)',
}

SCENARIO_NAMES_KR = {
    'shaheen_ncc_h2': '수소기반 전환 (NCC-H2)',
    'shaheen_ncc_elec': '전기화 전환 (NCC-Elec)',
    'shaheen_ncc_h2_15c': '수소기반 전환 1.5°C',
    'shaheen_ncc_h2_20c': '수소기반 전환 2.0°C',
    'shaheen_ncc_elec_15c': '전기화 전환 1.5°C',
    'shaheen_ncc_elec_20c': '전기화 전환 2.0°C',
}
