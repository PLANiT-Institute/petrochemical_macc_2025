...
df_shaheen = df_growth[df_growth['scenario'] == 'shaheen']
multiplier_2050 = df_shaheen[df_shaheen['year'] == 2050]['cumulative_capacity_multiplier'].iloc[0]
...
# 전체 전력 배출량
total_elec_emissions_kt = df_baseline['emissions_electricity_kt'].sum()
